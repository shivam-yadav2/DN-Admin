...
class ProjectController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($request->hasFile('image'))
        {
         ...
         // Save relative path in DB
                 $imageName = 'assets/images/projects/' . $imageName; // ✅ relative path in DB
        ...
        //       // Save relative path
        //     $videoName = 'assets/videos/projects/' . $videoName;
        // }
    ...
    public function update(Request $request, $id)
    {
        ...
        // $timestampVideo = time() . '.' . $videoExtension;
        // $video->move(('assets/videos/projects'), $timestampVideo);
        ...
        if ($request->hasFile('video'))
        {
            ...
            if ($project->video && file_exists($videoPath) && is_file($videoPath)) {
                unlink($videoPath);
            }
        ...
        $project->update([
              ...
              'image'           => $imageName,
              'video'           => $videoName,
              'description'     => $request->descripton ?? $project->description,
    ...
    if (!empty($project->video) && file_exists(public_path($project->video))) {
        unlink(public_path($project->video));
    }
