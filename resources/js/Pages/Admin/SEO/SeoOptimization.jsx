        ...
        <Layout>
            <div className="container mx-auto p-6">
                ...
                <div className="flex justify-between items-center mb-6">
                    ...
                    <ShowImg img="/assets/refImg/SEOoptimization.png" />
                </div>
                            ...
                            <CardContent>
                                ...
                                <div className="space-x-2">
                                    ...
                                    <Button
                                        variant="destructive"
                                        onClick={() =>
                                            handleDelete(seoOptimization.id)
                                        }
                                    >
                                        Delete
                                    </Button>
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                ...
                                permanently delete the SEO optimization.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
